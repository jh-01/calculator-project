...
public class App {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (menu == -1) break;
            else if(menu == 1) callCalculator(sc, arithmeticCalculator);
    ...
    public static void callCalculator(Scanner sc, ArithmeticCalculator arithmeticCalculator){
        int firstNumber;
        int secondNumber;
        int result;
        ...
        try {
            result = arithmeticCalculator.doCalculate(firstNumber, secondNumber, operator);
    ...
    public static OperatorType readOperator(Scanner sc, String message){
        System.out.print(message);
    ...
    public static void printResultList(ArithmeticCalculator arithmeticCalculator){
